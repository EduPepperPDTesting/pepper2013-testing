...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AsyncTask.progress'
        db.add_column('async_task', 'progress',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AsyncTask.progress'
        db.delete_column('async_task', 'progress')
    ...
    models = {
        'async_task.asynctask': {
            ...
            'group': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
