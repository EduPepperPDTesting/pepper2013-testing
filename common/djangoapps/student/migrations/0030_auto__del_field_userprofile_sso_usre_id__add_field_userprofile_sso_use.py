...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.sso_usre_id'
        db.delete_column('auth_userprofile', 'sso_usre_id')

        # Adding field 'UserProfile.sso_user_id'
        db.add_column('auth_userprofile', 'sso_user_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.sso_usre_id'
        db.add_column('auth_userprofile', 'sso_usre_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.sso_user_id'
        db.delete_column('auth_userprofile', 'sso_user_id')
