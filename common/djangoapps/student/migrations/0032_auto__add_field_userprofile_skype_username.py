...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.skype_username'
        db.add_column('auth_userprofile', 'skype_username',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.skype_username'
        db.delete_column('auth_userprofile', 'skype_username')
