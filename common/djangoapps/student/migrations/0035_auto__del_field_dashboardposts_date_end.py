...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DashboardPosts.date_end'
        db.delete_column('dashboard_posts', 'date_end')


    def backwards(self, orm):
        # Adding field 'DashboardPosts.date_end'
        db.add_column('dashboard_posts', 'date_end',
