...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.force_logout'
        db.add_column('auth_userprofile', 'force_logout',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.force_logout'
        db.delete_column('auth_userprofile', 'force_logout')
