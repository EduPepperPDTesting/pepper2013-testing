...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseEnrollment.is_closed'
        db.add_column('student_courseenrollment', 'is_closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseEnrollment.is_closed'
        db.delete_column('student_courseenrollment', 'is_closed')
