...
#@date:2013-11-08    
    ...
    courses_complated=sorted(courses_complated, key=lambda x:x.complete_date)
    courses_incomplated=sorted(courses_incomplated, key=lambda x:x.student_enrollment_date)
