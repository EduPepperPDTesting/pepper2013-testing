...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ImportTaskLog.district_name'
        db.delete_column('admin_import_task_log', 'district_name')

        # Deleting field 'ImportTaskLog.email'
        db.delete_column('admin_import_task_log', 'email')

        # Adding field 'ImportTaskLog.import_data'
        db.add_column('admin_import_task_log', 'import_data',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ImportTaskLog.district_name'
        db.add_column('admin_import_task_log', 'district_name',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=255, db_index=True),
                      keep_default=False)

        # Adding field 'ImportTaskLog.email'
        db.add_column('admin_import_task_log', 'email',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=75, db_index=True),
                      keep_default=False)

        # Deleting field 'ImportTaskLog.import_data'
        db.delete_column('admin_import_task_log', 'import_data')
