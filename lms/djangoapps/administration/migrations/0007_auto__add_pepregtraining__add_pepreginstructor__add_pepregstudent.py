...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PepRegTraining'
        db.create_table('pepreg_training', (
            ...
            ('training_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('training_time', self.gf('django.db.models.fields.TimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('administration', ['PepRegTraining'])

        # Adding model 'PepRegInstructor'
        db.create_table('pepreg_instructor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('administration', ['PepRegInstructor'])

        # Adding model 'PepRegStudent'
        db.create_table('pepreg_student', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('training', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.PepRegTraining'])),
            ...
            ('student_credit', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('user_create', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('date_create', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('user_modify', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('date_modify', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('administration', ['PepRegStudent'])


    def backwards(self, orm):
        # Deleting model 'PepRegTraining'
        db.delete_table('pepreg_training')

        # Deleting model 'PepRegInstructor'
        db.delete_table('pepreg_instructor')

        # Deleting model 'PepRegStudent'
        db.delete_table('pepreg_student')
    ...
    models = {
        ...
        'administration.pepregtraining': {
            ...
            'training_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'training_time': ('django.db.models.fields.TimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
