...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PepRegTraining.training_time'
        db.delete_column('pepreg_training', 'training_time')

        # Adding field 'PepRegTraining.training_time_start'
        db.add_column('pepreg_training', 'training_time_start',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PepRegTraining.training_time_end'
        db.add_column('pepreg_training', 'training_time_end',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PepRegTraining.training_time'
        db.add_column('pepreg_training', 'training_time',
                      self.gf('django.db.models.fields.TimeField')(default=None),
                      keep_default=False)

        # Deleting field 'PepRegTraining.training_time_start'
        db.delete_column('pepreg_training', 'training_time_start')

        # Deleting field 'PepRegTraining.training_time_end'
        db.delete_column('pepreg_training', 'training_time_end')
