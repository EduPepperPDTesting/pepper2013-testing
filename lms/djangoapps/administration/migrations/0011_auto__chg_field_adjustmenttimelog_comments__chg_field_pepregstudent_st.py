...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PepRegStudent.student_credit'
        db.alter_column('pepreg_student', 'student_credit', self.gf('django.db.models.fields.FloatField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PepRegStudent.student_credit'
        db.alter_column('pepreg_student', 'student_credit', self.gf('django.db.models.fields.IntegerField')())
