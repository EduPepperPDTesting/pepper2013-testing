...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserLoginInfo'
        db.create_table('user_login_info', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.IntegerField')(max_length=11)),
            ('login_time', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('logout_time', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('last_session', self.gf('django.db.models.fields.IntegerField')(max_length=15)),
            ('total_session', self.gf('django.db.models.fields.IntegerField')(max_length=30)),
            ('login_times', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=15)),
        ))
