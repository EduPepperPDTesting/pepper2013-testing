...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PepRegTraining_Backup'
        db.create_table('pepreg_training_hist', (
            ...
            ('pepper_course', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('training_date', self.gf('django.db.models.fields.DateField')()),
            ('training_time_start', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('training_time_end', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('geo_location', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('geo_props', self.gf('django.db.models.fields.TextField')(null=True)),
            ('classroom', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('credits', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('attendancel_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('allow_registration', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('max_registration', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('allow_attendance', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('allow_student_attendance', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('allow_validation', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_create', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('date_create', self.gf('django.db.models.fields.DateField')()),
            ('user_modify', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('date_modify', self.gf('django.db.models.fields.DateField')()),
            ('last_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('school_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('school_year', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('administration', ['PepRegTraining_Backup'])

        # Adding model 'PepRegInstructor_Backup'
        db.create_table('pepreg_instructor_hist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('training', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.PepRegTraining'])),
            ('instructor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('user_create', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('date_create', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('all_edit', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('all_delete', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('school_year', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('administration', ['PepRegInstructor_Backup'])

        # Adding model 'PepRegStudent_Backup'
        db.create_table('pepreg_student_hist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('training', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.PepRegTraining'])),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('student_status', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('student_credit', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('user_create', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('date_create', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('user_modify', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('date_modify', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('school_year', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('administration', ['PepRegStudent_Backup'])


    def backwards(self, orm):
        # Deleting model 'PepRegTraining_Backup'
        db.delete_table('pepreg_training_hist')

        # Deleting model 'PepRegInstructor_Backup'
        db.delete_table('pepreg_instructor_hist')

        # Deleting model 'PepRegStudent_Backup'
        db.delete_table('pepreg_student_hist')
    ...
    models = {
        ...
        'administration.customemaillog': {
            ...
            'email_name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'administration.pepreginstructor_backup': {
            'Meta': {'object_name': 'PepRegInstructor_Backup', 'db_table': "'pepreg_instructor_hist'"},
            'all_delete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'all_edit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'date_create': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['auth.User']"}),
            'school_year': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'training': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['administration.PepRegTraining']"}),
            'user_create': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['auth.User']"})
        },
        ...
        'administration.pepregstudent_backup': {
            'Meta': {'object_name': 'PepRegStudent_Backup', 'db_table': "'pepreg_student_hist'"},
            'date_create': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modify': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'school_year': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'administration.pepregtraining_backup': {
            'Meta': {'object_name': 'PepRegTraining_Backup', 'db_table': "'pepreg_training_hist'"},
            'allow_attendance': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_registration': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_student_attendance': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_validation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
