...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PepRegInstructor_Backup.training'
        db.alter_column('pepreg_instructor_hist', 'training_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.PepRegTraining']))

        # Renaming column for 'PepRegStudent_Backup.training' to match new field type.
        db.rename_column('pepreg_student_hist', 'training', 'training_id')
        # Changing field 'PepRegStudent_Backup.training'
        db.alter_column('pepreg_student_hist', 'training_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.PepRegTraining']))
    ...
    models = {
        ...
        'administration.pepreginstructor_backup': {
            ...
            'training': ('django.db.models.fields.IntegerField', [], {}),
            'user_create': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['auth.User']"})
        },
