...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PepRegTraining_Backup.id'
        db.alter_column('pepreg_training_hist', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Renaming column for 'PepRegInstructor_Backup.training' to match new field type.
        db.rename_column('pepreg_instructor_hist', 'training', 'training_id')
        # Changing field 'PepRegInstructor_Backup.training'
        db.alter_column('pepreg_instructor_hist', 'training_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.PepRegTraining_Backup']))
        # Adding index on 'PepRegInstructor_Backup', fields ['training']
        db.create_index('pepreg_instructor_hist', ['training_id'])


        # Renaming column for 'PepRegStudent_Backup.training' to match new field type.
        db.rename_column('pepreg_student_hist', 'training', 'training_id')
        # Changing field 'PepRegStudent_Backup.training'
        db.alter_column('pepreg_student_hist', 'training_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.PepRegTraining_Backup']))
        # Adding index on 'PepRegStudent_Backup', fields ['training']
        db.create_index('pepreg_student_hist', ['training_id'])


    def backwards(self, orm):
        # Removing index on 'PepRegStudent_Backup', fields ['training']
        db.delete_index('pepreg_student_hist', ['training_id'])

        # Removing index on 'PepRegInstructor_Backup', fields ['training']
        db.delete_index('pepreg_instructor_hist', ['training_id'])


        # Changing field 'PepRegTraining_Backup.id'
        db.alter_column('pepreg_training_hist', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Renaming column for 'PepRegInstructor_Backup.training' to match new field type.
        db.rename_column('pepreg_instructor_hist', 'training_id', 'training')
        # Changing field 'PepRegInstructor_Backup.training'
        db.alter_column('pepreg_instructor_hist', 'training', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'PepRegStudent_Backup.training' to match new field type.
        db.rename_column('pepreg_student_hist', 'training_id', 'training')
        # Changing field 'PepRegStudent_Backup.training'
        db.alter_column('pepreg_student_hist', 'training', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'administration.pepreginstructor_backup': {
            ...
            'training': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['administration.PepRegTraining_Backup']"}),
            'user_create': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['auth.User']"})
        },
