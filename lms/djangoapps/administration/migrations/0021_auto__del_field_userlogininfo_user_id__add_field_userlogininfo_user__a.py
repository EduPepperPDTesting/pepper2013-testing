...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserLoginInfo.user_id'
        db.delete_column('user_login_info', 'user_id')

        # Adding field 'UserLoginInfo.user'
        db.add_column('user_login_info', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='loginfo', to_field='user', null=True, to=orm['student.UserProfile']),
                      keep_default=False)

        # Adding field 'UserLoginInfo.password_change_date'
        db.add_column('user_login_info', 'password_change_date',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2017, 10, 13, 0, 0), max_length=30),
                      keep_default=False)

        # Deleting field 'PepRegInstructor_Backup.training'
        db.delete_column('pepreg_instructor_hist', 'training_id')

        # Adding field 'PepRegInstructor_Backup.training_id'
        db.add_column('pepreg_instructor_hist', 'training_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'PepRegStudent_Backup.training'
        db.delete_column('pepreg_student_hist', 'training_id')

        # Adding field 'PepRegStudent_Backup.training_id'
        db.add_column('pepreg_student_hist', 'training_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PepRegTraining.subjectother'
        db.add_column('pepreg_training', 'subjectother',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserLoginInfo.user_id'
        db.add_column('user_login_info', 'user_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=11),
                      keep_default=False)

        # Deleting field 'UserLoginInfo.user'
        db.delete_column('user_login_info', 'user_id')

        # Deleting field 'UserLoginInfo.password_change_date'
        db.delete_column('user_login_info', 'password_change_date')

        # Adding field 'PepRegInstructor_Backup.training'
        db.add_column('pepreg_instructor_hist', 'training',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['administration.PepRegTraining_Backup']),
                      keep_default=False)

        # Deleting field 'PepRegInstructor_Backup.training_id'
        db.delete_column('pepreg_instructor_hist', 'training_id')

        # Adding field 'PepRegStudent_Backup.training'
        db.add_column('pepreg_student_hist', 'training',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['administration.PepRegTraining_Backup']),
                      keep_default=False)

        # Deleting field 'PepRegStudent_Backup.training_id'
        db.delete_column('pepreg_student_hist', 'training_id')

        # Deleting field 'PepRegTraining.subjectother'
        db.delete_column('pepreg_training', 'subjectother')
