...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PepRegTraining.allow_waitlist'
        db.add_column('pepreg_training', 'allow_waitlist',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PepRegTraining.allow_waitlist'
        db.delete_column('pepreg_training', 'allow_waitlist')
