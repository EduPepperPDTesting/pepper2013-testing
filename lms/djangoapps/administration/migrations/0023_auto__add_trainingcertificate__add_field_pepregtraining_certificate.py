...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrainingCertificate'
        db.create_table('training_certificate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('certificate', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['administration.Certificate'], unique=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(related_name='certificates', to=orm['organization.OrganizationMetadata'])),
        ))
        db.send_create_signal('administration', ['TrainingCertificate'])

        # Adding field 'PepRegTraining.certificate'
        db.add_column('pepreg_training', 'certificate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.Certificate'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TrainingCertificate'
        db.delete_table('training_certificate')

        # Deleting field 'PepRegTraining.certificate'
        db.delete_column('pepreg_training', 'certificate_id')
