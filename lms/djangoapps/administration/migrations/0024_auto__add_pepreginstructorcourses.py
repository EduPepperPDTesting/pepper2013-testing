...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PepRegInstructorCourses'
        db.create_table('pepreg_instructor_courses', (
        ...
        db.send_create_signal('administration', ['PepRegInstructorCourses'])


    def backwards(self, orm):
        # Deleting model 'PepRegInstructorCourses'
        db.delete_table('pepreg_instructor_courses')
