...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PepRegStudentCourse'
        db.create_table('pepregstudent_course', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('training', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['administration.PepRegTraining'])),
            ('student_course_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['student.CourseEnrollment'])),
        ...
        db.send_create_signal('administration', ['PepRegStudentCourse'])

        # Deleting field 'PepRegStudent.course'
        db.delete_column('pepreg_student', 'course_id')


    def backwards(self, orm):
        # Deleting model 'PepRegStudentCourse'
        db.delete_table('pepregstudent_course')

        # Adding field 'PepRegStudent.course'
        db.add_column('pepreg_student', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['student.CourseEnrollment']),
                      keep_default=False)
    ...
    models = {
        'administration.adjustmenttimelog': {
            ...
            'user_id': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '11'})
        },
        ...
        'administration.pepreginstructor_backup': {
            ...
            'training_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'user_create': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['auth.User']"})
        },
        'administration.pepreginstructorcourses': {
        ...
        'administration.pepregstudentcourse': {
            'Meta': {'object_name': 'PepRegStudentCourse', 'db_table': "'pepregstudent_course'"},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['student.CourseEnrollment']"}),
            'date_create': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modify': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['auth.User']"}),
            'student_course_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'training': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['administration.PepRegTraining']"}),
            'user_create': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['auth.User']"}),
            'user_modify': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['auth.User']"})
        },
        'administration.pepregtraining': {
            ...
            'allow_waitlist': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'attendancel_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'certificate': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['administration.Certificate']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            ...
            'subjectother': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'administration.trainingcertificate': {
            'Meta': {'object_name': 'TrainingCertificate', 'db_table': "'training_certificate'"},
            'certificate': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['administration.Certificate']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'certificates'", 'to': "orm['organization.OrganizationMetadata']"})
        },
        'administration.userlogininfo': {
            ...
            'password_change_date': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'loginfo'", 'to_field': "'user'", 'null': 'True', 'to': "orm['student.UserProfile']"})
        },
        'auth.group': {
        ...
        'student.userprofile': {
            ...
            'district': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['student.District']", 'on_delete': 'models.PROTECT'}),
            'force_logout': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
