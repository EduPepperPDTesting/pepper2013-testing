...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'PepRegInstructorCourses.user_create'
        db.delete_column('pepreg_instructor_courses', 'user_create_id')

        # Deleting field 'PepRegInstructorCourses.date_modify'
        db.delete_column('pepreg_instructor_courses', 'date_modify')

        # Deleting field 'PepRegInstructorCourses.user_modify'
        db.delete_column('pepreg_instructor_courses', 'user_modify_id')
