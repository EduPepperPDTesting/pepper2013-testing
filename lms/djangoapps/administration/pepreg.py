...
def build_print_rows(request, _year, _month, _catype, all_occurrences, current_day, tmp_school_id, daterangelist):
    ...
    if(print_row):
        ...
        while(i < array_length):
            ...
            table_tr_content += "<td style='position: relative; height: 100%; width: auto; border: 1px #ccc solid;'>" + print_row[i][0] + " " + print_row[i][1] +"</td>"
            table_tr_content += "<td style='position: relative; height: 100%; width: auto; border: 1px #ccc solid;'>" + print_row[i][2] + "</td>"
            table_tr_content += "<td style='position: relative; height: 100%; width: auto; border: 1px #ccc solid;'>" + print_row[i][3] + "</td>"
            table_tr_content += "<td style='position: relative; height: 100%; width: auto; border: 1px #ccc solid;'>" + print_row[i][4] + " " + print_row[i][3] + "</td>"
