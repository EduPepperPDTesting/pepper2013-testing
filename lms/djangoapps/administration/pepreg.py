...
def build_print_rows(request, year, month, catype, all_occurrences, current_day, getrange, daterangelist):
    ...
    if(print_row):
        ...
        while(i < array_length):
            ...
            table_tr_content += "<td style='width: 25% !important;padding: 2px !important; border-left: 1px solid #d5d5d5 !important;'>" + str(print_row[i][0]) + "<br/>" + ti_text_span +"</td>"
                            ...
                            if day[1]:
                                ...
                                for tmp1 in day[1]:
                                    ...
                                    if(day[4][i] != "" and (day[3][i] != day[4][i])):
                                        ...
                                        if(startHour >= 1 and startHourAMPM == "PM"):
                                            raise Exception('pm')
