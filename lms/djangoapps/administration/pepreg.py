    ...
    if regular_search == 1:
        ...
        for field_item in field_list:
            ...
            if (item_order == len(conditions) or condition == 'and') and (item_order == 0 or conditions[prev_item_order].encode("utf-8") == 'and'):
                if item_order == 1: raise Exception("1 item_order=" + str(item_order) + " list=" + str(search_list[item_order]) + "prev conditions=" + str(conditions[prev_item_order].encode("utf-8")))
