...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CertificateImages'
        db.create_table('certificate_images', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('certificates', ['CertificateImages'])


    def backwards(self, orm):
        # Deleting model 'CertificateImages'
        db.delete_table('certificate_images')
    ...
    models = {
        ...
        'certificates.certificateimages': {
            'Meta': {'object_name': 'CertificateImages', 'db_table': "'certificate_images'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
