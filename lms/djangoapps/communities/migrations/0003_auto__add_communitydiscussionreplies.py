...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('community_discussion_replies', (
            ...
            ('discussion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communities.CommunityDiscussions'], on_delete=models.PROTECT)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('post', self.gf('django.db.models.fields.TextField')(max_length=255, db_index=False)),
    ...
    models = {
        ...
        'communities.communitydiscussionreplies': {
            ...
            'post': ('django.db.models.fields.TextField', [], {'max_length': '255', 'db_index': 'False'}),
