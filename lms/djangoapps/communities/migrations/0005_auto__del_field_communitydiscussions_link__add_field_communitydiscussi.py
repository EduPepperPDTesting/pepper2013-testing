...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CommunityDiscussions.link'
        db.delete_column('community_discussions', 'link')

        # Adding field 'CommunityDiscussions.attachment'
        db.add_column('community_discussions', 'attachment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['file_uploader.FileUploads'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Deleting field 'CommunityDiscussionReplies.link'
        db.delete_column('community_discussion_replies', 'link')

        # Adding field 'CommunityDiscussionReplies.attachment'
        db.add_column('community_discussion_replies', 'attachment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['file_uploader.FileUploads'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CommunityDiscussions.link'
        db.add_column('community_discussions', 'link',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)

        # Deleting field 'CommunityDiscussions.attachment'
        db.delete_column('community_discussions', 'attachment_id')

        # Adding field 'CommunityDiscussionReplies.link'
        db.add_column('community_discussion_replies', 'link',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)

        # Deleting field 'CommunityDiscussionReplies.attachment'
        db.delete_column('community_discussion_replies', 'attachment_id')
