...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CommunityDiscussions.date_create'
        db.alter_column('community_discussions', 'date_create', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'CommunityDiscussionReplies.date_create'
        db.alter_column('community_discussion_replies', 'date_create', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'CommunityDiscussions.date_create'
        db.alter_column('community_discussions', 'date_create', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'CommunityDiscussionReplies.date_create'
        db.alter_column('community_discussion_replies', 'date_create', self.gf('django.db.models.fields.DateTimeField')())
