...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CommunityDiscussions.community'
        db.alter_column('community_discussions', 'community_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communities.CommunityCommunities']))

        # Changing field 'CommunityResources.community'
        db.alter_column('community_resources', 'community_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communities.CommunityCommunities']))

        # Changing field 'CommunityCourses.community'
        db.alter_column('community_courses', 'community_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communities.CommunityCommunities']))

        # Changing field 'CommunityDiscussionReplies.discussion'
        db.alter_column('community_discussion_replies', 'discussion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communities.CommunityDiscussions']))

        # Changing field 'CommunityUsers.community'
        db.alter_column('community_users', 'community_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communities.CommunityCommunities']))

    def backwards(self, orm):

        # Changing field 'CommunityDiscussions.community'
        db.alter_column('community_discussions', 'community_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communities.CommunityCommunities'], on_delete=models.PROTECT))

        # Changing field 'CommunityResources.community'
        db.alter_column('community_resources', 'community_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communities.CommunityCommunities'], on_delete=models.PROTECT))

        # Changing field 'CommunityCourses.community'
        db.alter_column('community_courses', 'community_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communities.CommunityCommunities'], on_delete=models.PROTECT))

        # Changing field 'CommunityDiscussionReplies.discussion'
        db.alter_column('community_discussion_replies', 'discussion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communities.CommunityDiscussions'], on_delete=models.PROTECT))

        # Changing field 'CommunityUsers.community'
        db.alter_column('community_users', 'community_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communities.CommunityCommunities'], on_delete=models.PROTECT))
