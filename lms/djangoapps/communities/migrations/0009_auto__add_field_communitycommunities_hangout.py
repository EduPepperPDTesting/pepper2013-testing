...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommunityCommunities.hangout'
        db.add_column('community_communities', 'hangout',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommunityCommunities.hangout'
        db.delete_column('community_communities', 'hangout')
