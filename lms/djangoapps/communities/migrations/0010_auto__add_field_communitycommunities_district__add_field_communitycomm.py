...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommunityCommunities.district'
        db.add_column('community_communities', 'district',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['student.District'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Adding field 'CommunityCommunities.state'
        db.add_column('community_communities', 'state',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['student.State'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommunityCommunities.district'
        db.delete_column('community_communities', 'district_id')

        # Deleting field 'CommunityCommunities.state'
        db.delete_column('community_communities', 'state_id')
