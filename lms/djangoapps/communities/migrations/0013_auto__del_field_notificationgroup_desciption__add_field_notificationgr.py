...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationGroup.description'
        db.add_column('community_notification_group', 'description',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NotificationGroup.description'
        db.delete_column('community_notification_group', 'description')
