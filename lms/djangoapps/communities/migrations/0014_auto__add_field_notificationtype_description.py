...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotificationType.description'
        db.add_column('community_notification_type', 'description',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2016, 6, 15, 0, 0), max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotificationType.description'
        db.delete_column('community_notification_type', 'description')
