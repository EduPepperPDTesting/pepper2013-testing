...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NotificationType.type'
        db.delete_column('community_notification_type', 'type')

        # Adding field 'NotificationType.name'
        db.add_column('community_notification_type', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NotificationType.type'
        db.add_column('community_notification_type', 'type',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'NotificationType.name'
        db.delete_column('community_notification_type', 'name')
