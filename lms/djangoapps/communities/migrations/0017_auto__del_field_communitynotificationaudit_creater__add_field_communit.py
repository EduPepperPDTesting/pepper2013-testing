...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CommunityNotificationAudit.creater'
        db.delete_column('community_notification_audit', 'creater_id')

        # Adding field 'CommunityNotificationAudit.creator'
        db.add_column('community_notification_audit', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User'], on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CommunityNotificationAudit.creater'
        db.add_column('community_notification_audit', 'creater',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2016, 7, 14, 0, 0), to=orm['auth.User'], on_delete=models.PROTECT),
                      keep_default=False)

        # Deleting field 'CommunityNotificationAudit.creator'
        db.delete_column('community_notification_audit', 'creator_id')
