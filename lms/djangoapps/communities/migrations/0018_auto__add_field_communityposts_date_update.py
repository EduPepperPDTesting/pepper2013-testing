...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommunityPosts.date_update'
        db.add_column('community_posts', 'date_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2016, 7, 21, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommunityPosts.date_update'
        db.delete_column('community_posts', 'date_update')
