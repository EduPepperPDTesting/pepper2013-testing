...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotificationConfig.user_modify'
        db.add_column('community_notification_config', 'user_modify',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='+', on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'NotificationConfig.frequency'
        db.alter_column('community_notification_config', 'frequency', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):
        # Deleting field 'NotificationConfig.user_modify'
        db.delete_column('community_notification_config', 'user_modify_id')


        # Changing field 'NotificationConfig.frequency'
        db.alter_column('community_notification_config', 'frequency', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        'communities.notificationconfig': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'user_modify': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'on_delete': 'models.PROTECT', 'to': "orm['auth.User']"}),
