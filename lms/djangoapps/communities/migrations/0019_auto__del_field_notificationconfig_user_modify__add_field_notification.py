...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationConfig.self_config'
        db.add_column('community_notification_config', 'self_config',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NotificationConfig.self_config'
        db.delete_column('community_notification_config', 'self_config')
