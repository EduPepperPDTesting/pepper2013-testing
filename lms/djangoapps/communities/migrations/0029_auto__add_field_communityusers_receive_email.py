...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommunityUsers.receive_email'
        db.add_column('community_users', 'receive_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommunityUsers.receive_email'
        db.delete_column('community_users', 'receive_email')
