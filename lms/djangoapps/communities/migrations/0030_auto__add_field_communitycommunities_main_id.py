...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommunityCommunities.main_id'
        db.add_column('community_communities', 'main_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=11),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommunityCommunities.main_id'
        db.delete_column('community_communities', 'main_id')
