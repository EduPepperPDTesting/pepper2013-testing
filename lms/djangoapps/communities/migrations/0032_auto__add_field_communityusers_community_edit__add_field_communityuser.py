...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommunityUsers.community_edit'
        db.add_column('community_users', 'community_edit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CommunityUsers.community_delete'
        db.add_column('community_users', 'community_delete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommunityUsers.community_edit'
        db.delete_column('community_users', 'community_edit')

        # Deleting field 'CommunityUsers.community_delete'
        db.delete_column('community_users', 'community_delete')
