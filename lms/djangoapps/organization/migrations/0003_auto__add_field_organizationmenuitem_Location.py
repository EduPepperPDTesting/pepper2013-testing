...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizationMenuitem.Location'
        db.add_column('organization_menuitem', 'Location',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizationMenuitem.Location'
        db.delete_column('organization_menuitem', 'Location')
