...
from reporting.models import course_from_id
...
def organizational_save_base(request):
    try:
        ...
        new_PeppTalk = request.POST.get("new_PeppTalk", "")
        new_PeppTalk_curr = request.POST.get("new_PeppTalk_curr", "")
        ...
        if oid:
            ...
            org_organizationdashboardsave(org_metadata, "PeppTalk Curriculumn", new_PeppTalk_curr)
            org_organizationdashboardsave(org_metadata, "PeppTalk", new_PeppTalk)
