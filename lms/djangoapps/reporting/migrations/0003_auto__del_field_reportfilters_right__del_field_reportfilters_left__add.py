...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReportFilters.right'
        db.delete_column('reporting_report_filters', 'right_id')

        # Deleting field 'ReportFilters.left'
        db.delete_column('reporting_report_filters', 'left_id')

        # Adding field 'ReportFilters.view'
        db.add_column('reporting_report_filters', 'view',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['reporting.ViewColumns'], on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'ReportFilters.value'
        db.add_column('reporting_report_filters', 'value',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ReportFilters.right'
        db.add_column('reporting_report_filters', 'right',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='reportfilters_right', on_delete=models.PROTECT, to=orm['reporting.ViewColumns']),
                      keep_default=False)

        # Adding field 'ReportFilters.left'
        db.add_column('reporting_report_filters', 'left',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='reportfilters_left', on_delete=models.PROTECT, to=orm['reporting.ViewColumns']),
                      keep_default=False)

        # Deleting field 'ReportFilters.view'
        db.delete_column('reporting_report_filters', 'view_id')

        # Deleting field 'ReportFilters.value'
        db.delete_column('reporting_report_filters', 'value')
    ...
    models = {
        ...
        'reporting.reportfilters': {
            ...
            'view': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['reporting.ViewColumns']", 'on_delete': 'models.PROTECT'})
        },
        'reporting.reports': {
