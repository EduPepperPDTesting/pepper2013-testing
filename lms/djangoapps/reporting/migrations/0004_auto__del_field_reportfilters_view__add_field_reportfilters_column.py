...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportFilters.column'
        db.add_column('reporting_report_filters', 'column',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ReportFilters.column'
        db.delete_column('reporting_report_filters', 'column_id')
