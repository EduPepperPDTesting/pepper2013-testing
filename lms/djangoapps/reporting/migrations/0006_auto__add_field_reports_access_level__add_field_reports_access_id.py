...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reports.access_level'
        db.add_column('reporting_reports', 'access_level',
                      self.gf('django.db.models.fields.CharField')(default='System', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Reports.access_id'
        db.add_column('reporting_reports', 'access_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reports.access_level'
        db.delete_column('reporting_reports', 'access_level')

        # Deleting field 'Reports.access_id'
        db.delete_column('reporting_reports', 'access_id')
