...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportViewColumns.order'
        db.add_column('reporting_report_view_columns', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportViewColumns.order'
        db.delete_column('reporting_report_view_columns', 'order')
