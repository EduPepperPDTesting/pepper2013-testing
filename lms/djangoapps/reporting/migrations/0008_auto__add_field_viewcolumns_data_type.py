...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ViewColumns.data_type'
        db.add_column('reporting_view_columns', 'data_type',
                      self.gf('django.db.models.fields.CharField')(default='text', max_length=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ViewColumns.data_type'
        db.delete_column('reporting_view_columns', 'data_type')
