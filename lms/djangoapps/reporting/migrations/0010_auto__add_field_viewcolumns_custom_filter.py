...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ViewColumns.custom_filter'
        db.add_column('reporting_view_columns', 'custom_filter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ViewColumns.custom_filter'
        db.delete_column('reporting_view_columns', 'custom_filter')
