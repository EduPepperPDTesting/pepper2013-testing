...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReportMatrixColumns'
        db.create_table('reporting_matrix_columns', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reporting.Reports'])),
            ('column_headers', self.gf('django.db.models.fields.IntegerField')()),
            ('row_headers', self.gf('django.db.models.fields.IntegerField')()),
            ('aggregate_data', self.gf('django.db.models.fields.IntegerField')()),
            ('aggregate_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('reporting', ['ReportMatrixColumns'])

        # Adding field 'Reports.report_type'
        db.add_column('reporting_reports', 'report_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ReportMatrixColumns'
        db.delete_table('reporting_matrix_columns')

        # Deleting field 'Reports.report_type'
        db.delete_column('reporting_reports', 'report_type')
    ...
    models = {
        ...
        'reporting.reportmatrixcolumns': {
            'Meta': {'object_name': 'ReportMatrixColumns', 'db_table': "'reporting_matrix_columns'"},
            'aggregate_data': ('django.db.models.fields.IntegerField', [], {}),
            'aggregate_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'column_headers': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['reporting.Reports']"}),
            'row_headers': ('django.db.models.fields.IntegerField', [], {})
        },
        'reporting.reports': {
            'Meta': {'object_name': 'Reports'},
            'access_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'access_level': ('django.db.models.fields.CharField', [], {'default': "'System'", 'max_length': '10', 'blank': 'True'}),
        ...
        'reporting.viewcolumns': {
            ...
            'custom_filter': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'data_type': ('django.db.models.fields.CharField', [], {'default': "'text'", 'max_length': '4', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'view': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['reporting.Views']"})
