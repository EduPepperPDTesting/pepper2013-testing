...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('queue_job', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1294, to=orm['auth.User'], on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.user'
        db.delete_column('queue_job', 'user_id')
