...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TNLCourses'
        db.create_table('tnl_courses', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('tnl_id', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, blank=True)),
            ('section_id', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, blank=True)),
            ('registered', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('registration_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
        ))
        db.send_create_signal('tnl_integration', ['TNLCourses'])

        # Adding model 'TNLDistricts'
        db.create_table('tnl_districts', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['student.District'])),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('tnl_integration', ['TNLDistricts'])

        # Adding model 'TNLCompletionTrack'
        db.create_table('tnl_completion_track', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User'])),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tnl_integration.TNLCourses'])),
            ('registered', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('registration_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
        ))
        db.send_create_signal('tnl_integration', ['TNLCompletionTrack'])


    def backwards(self, orm):
        # Deleting model 'TNLCourses'
        db.delete_table('tnl_courses')

        # Deleting model 'TNLDistricts'
        db.delete_table('tnl_districts')

        # Deleting model 'TNLCompletionTrack'
        db.delete_table('tnl_completion_track')
    ...
    models = {
        ...
        'tnl_integration.tnlcompletiontrack': {
            ...
            'registration_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
        ...
        'tnl_integration.tnlcourses': {
            ...
            'registered': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'registration_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'section_id': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'tnl_id': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'})
        },
