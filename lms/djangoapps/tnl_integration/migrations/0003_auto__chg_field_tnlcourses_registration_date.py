...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TNLCourses.registration_date'
        db.alter_column('tnl_courses', 'registration_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'TNLCourses.registration_date'
        db.alter_column('tnl_courses', 'registration_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 11, 9, 0, 0)))
