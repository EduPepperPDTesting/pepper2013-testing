...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TNLCourses.date_added'
        db.alter_column('tnl_courses', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'TNLCourses.date_added'
        db.alter_column('tnl_courses', 'date_added', self.gf('django.db.models.fields.DateTimeField')())
