...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TNLDomains.edagancy_id'
        db.delete_column('tnl_domains', 'edagancy_id')

        # Adding field 'TNLDomains.edagency_id'
        db.add_column('tnl_domains', 'edagency_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TNLDomains.edagancy_id'
        db.add_column('tnl_domains', 'edagancy_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)

        # Deleting field 'TNLDomains.edagency_id'
        db.delete_column('tnl_domains', 'edagency_id')
    ...
    models = {
        ...
        'tnl_integration.tnldomains': {
            ...
            'edagency_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
