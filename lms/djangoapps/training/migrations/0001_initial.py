...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrainingTrainings'
        db.create_table('training_trainings', (
        ...
        db.send_create_signal('training', ['TrainingTrainings'])

        # Adding model 'TrainingUsers'
        db.create_table('training_users', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('training', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['training.TrainingTrainings'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.PROTECT)),
        ))
        db.send_create_signal('training', ['TrainingUsers'])


    def backwards(self, orm):
        # Deleting model 'TrainingTrainings'
        db.delete_table('training_trainings')

        # Deleting model 'TrainingUsers'
        db.delete_table('training_users')
    ...
    models = {
        ...
        'training.trainingusers': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'training': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['training.TrainingTrainings']"}),
