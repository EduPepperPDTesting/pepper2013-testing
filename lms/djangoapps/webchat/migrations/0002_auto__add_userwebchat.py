...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserWebchat'
        db.create_table('auth_user_webchat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('session_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('webchat', ['UserWebchat'])


    def backwards(self, orm):
        # Deleting model 'UserWebchat'
        db.delete_table('auth_user_webchat')
