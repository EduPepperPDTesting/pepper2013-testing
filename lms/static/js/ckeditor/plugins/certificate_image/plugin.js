/**
 * modified form the Image plugin.
 */

( function() {

    CKEDITOR.plugins.add( 'certificate_image', {
        requires: 'dialog',
        ...
        init: function( editor ) {
            ...
            var pluginName = 'certificate_image';

            // Register the dialog.
            CKEDITOR.dialog.add( pluginName, this.path + 'dialogs/certificate_image.js' );
