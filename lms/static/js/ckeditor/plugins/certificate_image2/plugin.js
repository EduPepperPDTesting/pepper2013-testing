...
( function() {
	...
	CKEDITOR.plugins.add( 'certificate_image2', {
		requires: 'dialog',
		// jscs:disable maximumLineLength
		lang: 'en', // %REMOVE_LINE_CORE%
		// jscs:enable maximumLineLength
		icons: 'certificate_image2', // %REMOVE_LINE_CORE%
		...
		init: function( editor ) {
			...
			var pluginName = 'certificate_image2';

			// Register the dialog.
			CKEDITOR.dialog.add( pluginName, this.path + 'dialogs/certificate_image2.js' );
			...
			editor.on( 'doubleclick', function( evt ) {
				...
				if ( element.is( 'img' ) && !element.data( 'cke-realelement' ) && !element.isReadOnly() )
					evt.data.dialog = 'certificate_image2';
			} );
