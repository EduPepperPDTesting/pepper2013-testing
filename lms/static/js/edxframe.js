...
['<p><span id="loadingchat">Loading chat...</span>',
 ...
 '       style="position: absolute; top: -9999em; visibility: hidden;height:600px;"',
...
function getCourseChannel(){
  return $("#page-nav").find("h2")[0].innerHTML.replace(/<span.+?>.+<\/span>\s*/,"").replace(/_.+$/g,"")
}
...
function updateChatUrl() {
  ...
  document.getElementById('chatiframe').src =
      ...
      '?channels=' + getCourseChannel() + //encodeURIComponent(chatChannels) +
