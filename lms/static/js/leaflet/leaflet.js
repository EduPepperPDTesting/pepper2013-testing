...
!function (t, e, i) {
  ...
  o.Mixin.Events = {
    addEventListener: function (t, e, i) {
      ...
      ], d[u] = (d[u] || 0) + 1), c[p].push(r))  : (d[h] = d[h] || [
      ], d[h].push(r));
      return this
    },
  ...
  o.Map = o.Class.extend({
    ...
    fitBounds: function (t, e) {
      ...
      var i = o.point(e.paddingTopLeft || e.padding || [
        0,
        0
      ]),
      n = o.point(e.paddingBottomRight || e.padding || [
        0,
        0
      ]),
  ...
  o.Marker.include({
    ...
    bindPopup: function (t, e) {
      var i = o.point(this.options.icon.options.popupAnchor || [
        0,
        0
      ]);
