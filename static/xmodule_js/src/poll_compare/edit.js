...
(function() {
  ...
  this.POLLCompareEditingDescriptor = (function() {
    POLLCompareEditingDescriptor.isInactiveClass = "is-inactive";

    function POLLCompareEditingDescriptor(element) {
      ...
      this.$advancedEditorWrapper.addClass(POLLCompareEditingDescriptor.isInactiveClass);
      this.$baseUrl = "/static";
      tinyMCE.baseURL = "" + this.$baseUrl + "/js/vendor/tiny_mce";
      this.tiny_mce_textarea = $(".tiny-mce", this.element).tinymce({
        script_url: "" + this.$baseUrl + "/js/vendor/tiny_mce/tiny_mce.js",
        theme: "advanced",
        skin: 'studio',
        schema: "html5",
        convert_urls: false,
        content_css: "" + this.$baseUrl + "/css/tiny-mce.css",
        popup_css: "" + this.$baseUrl + "/js/vendor/tiny_mce/themes/advanced/skins/default/dialog.css",
        formats: {
          h4: {},
          h5: {},
          h6: {},
      ...
      this.showingVisualEditor = false;
      $element = $(element);
    ...
    POLLCompareEditingDescriptor.prototype.setupTinyMCE = function(ed) {
      ed.addButton('wrapAsCode', {
        title: 'Code',
        image: "" + this.$baseUrl + "/images/ico-tinymce-code.png",
        onclick: function() {
    ...
    POLLCompareEditingDescriptor.prototype.onSwitchEditor = function(e) {
      var $currentTarget, visualEditor;
      e.preventDefault();
      $currentTarget = $(e.currentTarget);
      if (!$currentTarget.hasClass('current')) {
        $currentTarget.addClass('current');
        this.$mceToolbar.toggleClass(POLLCompareEditingDescriptor.isInactiveClass);
        this.$advancedEditorWrapper.toggleClass(POLLCompareEditingDescriptor.isInactiveClass);
    ...
    POLLCompareEditingDescriptor.prototype.showAdvancedEditor = function(visualEditor) {
      var content;
    ...
    POLLCompareEditingDescriptor.prototype.showVisualEditor = function(visualEditor) {
      var content;
    ...
    POLLCompareEditingDescriptor.prototype.initInstanceCallback = function(visualEditor) {
    ...
    POLLCompareEditingDescriptor.prototype.focusVisualEditor = function(visualEditor) {
      visualEditor.focus();
    ...
    POLLCompareEditingDescriptor.prototype.getVisualEditor = function() {
      /*
    ...
    POLLCompareEditingDescriptor.prototype.unescape = function(str) {
      str = str.replace("$lt;", "<");
      str = str.replace("&gt;", ">");
      str = str.replace("&amp;", "&");
      return str;
    ...
    POLLCompareEditingDescriptor.prototype.save = function() {
      var text;
    ...
    return POLLCompareEditingDescriptor;
