...
'postInit': function () {
        ...
        $.each(this.jsonConfig, function(index,value){
            ...
            table_row_html ='' +
            '<ul>' +
                '<li class="row_left left">'+ i + '. '+ value.display_name +'.</li>' +
    ...
    $.each(this.jsonConfig,function(index,value){
        ...
        for(var col = 0;col<from_num;col++)
        {
            ...
            ul_fromObj.className = ul_fromObj.className + " set_green";
        }
        for(var col = 0;col<to_num;col++)
        {
            li_colObj = li_colObjS[col+1]; //li
            ul_toObj = li_colObj.children[1];
            ul_toObj.className = ul_toObj.className + " set_blue";
        }
    ...
    for(var i=1;i<ul_rowObjS.length;i++)
    {
        ...
        {
            ul_rowObjS[i].children[j].style.width = "" + ul_rowObjS[0].children[j].offsetWidth + "px";
            ul_rowObjS[i].children[j].offsetWidth = ul_rowObjS[0].children[j].offsetWidth;
            ul_rowObjS[i].children[j].children[0].offsetWidth = ul_rowObjS[0].children[j].offsetWidth;
            ul_rowObjS[i].children[j].children[0].style.width = "" + ul_rowObjS[0].children[j].offsetWidth + "px";
            ul_rowObjS[i].children[j].children[1].offsetWidth = ul_rowObjS[0].children[j].offsetWidth;
            ul_rowObjS[i].children[j].children[1].style.width = "" + ul_rowObjS[0].children[j].offsetWidth + "px";
        }
    }
    ...
    ul_rowObjS[0].children[0].offsetWidth = max_left_width;
    ul_rowObjS[0].children[0].style.width = "" + max_left_width + "px";
        return;
