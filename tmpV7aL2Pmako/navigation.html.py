...
_magic_number = 8
_modified_time = 1465224088.623107
_enable_loop = True
...
def _mako_generate_namespaces(context):
    ...
    # SOURCE LINE 5
    ns = runtime.TemplateNamespace('__anon_0x77f5c90', context._clean_inheritance_tokens(), templateuri=u'main.html', callables=None,  calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x77f5c90')] = ns
...
def render_body(context,show_extended=True,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x77f5c90')._populate(_import_ns, [u'login_query', u'stanford_theme_enabled'])
